          ...
          <div class="table-responsive p-0">
            ...
            >
              ...
              <template v-slot:cell(actions)="row">
                <b-button
                  :to="{
                    name: 'dashboard-transaction-edit-id',
...
export default {
  ...
  head() {
    return {
      title: "Transactions - Coffe Shop - Android Corners",
    };
  },
  ...
  async asyncData({ $axios, query }) {
    ...
    const products = await $axios.$get(
      `/api/dashboard/transactions?q=${search}&page=${page}`
    );
      ...
      this.$swal
        ...
        .then((result) => {
          if (result.isConfirmed) {
            ...
            this.$axios.delete(`/api/dashboard/transactions/${id}`).then(() => {
              //feresh data
              this.$nuxt.refresh();
